...
// esta es la generacion de forma estatica de todos los argumentos
// que puede recibir getStaticProps
export const getStaticPaths: GetStaticPaths = async (ctx) => {

    //const pokemons151 = [...Array(151)].map((value, index) => `${index + 1}`);
  
    const { data } = await pokeApi.get<PokemonListResponse>('/pokemon', { params : { limit: '151'}});
